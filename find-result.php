...
<html lang="en">
    <head>
        ...
        <title>Result Processing Management System</title>
                        ...
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4>Result Processing Management System</h4>
                                </div>
                            </div>
                            <div class="panel-body p-20">
                                ...
                                <form action="result.php" method="post">
                                	<div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="rollid" placeholder="Enter Your Reg No" autocomplete="off" name="rollid">
                                	</div>
                               <div class="form-group">
...
<?php }} ?>
                        ...
                        <!-- /.panel -->
                        <p class="text-muted text-center"><small>Copyright © ABDULJABBAR YAZID  2022</small></p>
                    </div>
