...
<html lang="en">
    <head>
        ...
        <title>RPS Admin Update Level</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Update Student Level</h2>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Update Student Level info</h5>
                                                </div>
                                            </div>
<?php if($msg){?>
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                       ...
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Level Name in Numeric</label>
                                                        <div class="">
